...
export default function LoginPage({ onSessionCreated }: Props) {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: '#ffffff', fontFamily: '"IBM Plex Sans", Arial, Helvetica, FreeSans, sans-serif', lineHeight: '1.5rem', fontSize: '1rem', color: '#333' }}>
      ...
      <main className="flex-1 sm:mt-[26px] mt-0 flex justify-center sm:px-0">
        <div className="flex flex-col lg:flex-row gap-[60px] items-center lg:items-start">
          <div className="bg-white mx-auto lg:mx-0 w-full lg:max-w-[400px]" style={{ minHeight: '24.8rem', height: 588, border: '1px solid #e0e0e0', marginTop: 26 }}>
