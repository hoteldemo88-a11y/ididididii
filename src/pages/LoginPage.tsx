    ...
    <div className="min-h-screen flex flex-col" style={{ background: '#f0f1f3', fontFamily: '"IBM Plex Sans", Arial, Helvetica, FreeSans, sans-serif', lineHeight: '1.5rem', fontSize: '1rem', color: '#333' }}>
      ...
      <main className="flex-1 sm:mt-[26px] mt-0 flex justify-center">
        <div className="flex flex-col lg:flex-row gap-[60px] items-center lg:items-start">
          <div style={{ width: 400, minHeight: '24.8rem', height: 588 }} className="bg-white shadow-[0_0_4px_rgba(0,0,0,0.08)] mx-auto lg:mx-0">
            <form onSubmit={handleSubmit} style={{ width: '100%', display: 'flex', flexDirection: 'column' }} className="px-7 py-6 h-full">
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  ...
                  <div role="button" onClick={() => setShowUserId(!showUserId)} className="absolute right-3 top-1/2 -translate-y-1/2 text-[14px] text-gray-500 hover:text-gray-700 cursor-pointer select-none" tabIndex={0}>
              ...
              <div className="mt-5 mb-1">
                <a href="#" className="inline-flex items-center gap-2 text-[#0055a5] hover:underline text-[14px]">
